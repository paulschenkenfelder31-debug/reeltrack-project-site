...
The Android source lives in `android/`. GitHub Actions builds ReelTrack v3.1, publishes the installable APK as a workflow artifact, and includes it in the deployed website at `public/downloads/ReelTrack-v3.1.apk`.
